...
public class FrmRegistroEmpleado extends JInternalFrame implements ActionListener, KeyListener {
	...
	private JLabel lblRegistroDeEmpleado;
	...
	public FrmRegistroEmpleado() {
		...
		lblRegistroDeEmpleado = new JLabel("Registro de Empleado");
		lblRegistroDeEmpleado.setHorizontalAlignment(SwingConstants.CENTER);
		lblRegistroDeEmpleado.setFont(new Font("Sylfaen", Font.BOLD, 24));
		lblRegistroDeEmpleado.setBounds(0, 37, 886, 37);
		getContentPane().add(lblRegistroDeEmpleado);
	}
